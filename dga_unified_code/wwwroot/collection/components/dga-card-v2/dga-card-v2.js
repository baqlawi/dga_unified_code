...
export class DgaCardV2 {
    ...
    render() {
        return (h(Host, { key: 'b3cf7be36254d48019e14dc943e877b2a24cdd55', id: this.componentId, style: this.rootStyles }, h("div", Object.assign({ key: '4be28fe16ebf66b1d77b5c9def28c85f1be7c877', class: `card ${this.disabled ? 'disabled' : ''} ${this.isFocused ? 'focused' : ''} card--${this.effect}`, onMouseEnter: this.onMouseEnterHandler, onMouseLeave: this.onMouseLeaveHandler }, (this.type === 'selectable' ? { onClick: this.onCheckboxChange } : {}), { style: this.cardStyles }), this.type === 'selectable' && (h("div", { key: '0c80673ea92c7459e4a5580e5eb26f24e4f78e80', class: "card__checkbox-container" }, h("dga-checkbox", { key: 'f8176513580648d3668225146b0f0735279f6899', checked: this.isSelected, color: "brand", onChange: this.onCheckboxChange }))), h("slot", { key: '7ab63199ea439af1d42f8cc94b02d0323c727d33', name: 'card-content' }), this.type === 'default' && h("slot", { key: 'bcdfbcb0a8c494559ff1b69571de7fee7d9052a8', name: 'card-actions' }))));
    }
