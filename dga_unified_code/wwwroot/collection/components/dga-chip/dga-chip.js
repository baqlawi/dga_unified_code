...
export class DgaChip {
    ...
    render() {
        return (h(Host, { key: 'b45e82abd297ad28cd4b4c91fc1bd520592c53ee', id: this.componentId, style: this.rootStyles }, h("span", { key: 'a1eba904c424ecf00f6d12fa7d11bbc91b3bf013', tabindex: "0", class: `chip chip--${this.variant} chip--${this.size} ${this.rounded ? 'chip--rounded' : ''} ${this.disabled ? 'disabled' : ''} ${this.pressed ? 'pressed' : ''} ${this.isSelected ? "selected" : ""}`, onMouseDown: () => (this.pressed = true), onMouseUp: () => (this.pressed = false), "aria-disabled": this.disabled, onClick: () => {
                if (this.isSelected) {
            ...
            } }, this.leadIcon ? h("span", { class: "chip-icon" }, this.renderIcon(this.leadIcon, this.leadIconProps)) : '', this.label, this.trailIcon ? h("span", { class: "chip-icon" }, this.renderIcon(this.trailIcon, this.trailIconProps)) : '', h("slot", { key: 'c3c0fc376ae83a4fbc6fcac51f4f3c59e5a6c038' }))));
    }
