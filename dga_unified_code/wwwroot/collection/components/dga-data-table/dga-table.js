...
export class DgaTable {
    ...
    render() {
        return (h("div", { key: '8e94be66fc1151acf00ede8441b1c96436b111d9', class: `table-wrapper ${this.contained ? 'table-contained' : ''}` }, h("table", { key: 'e3e91108267b1cb9e383a93ed4404cd77d94610b', class: ` azm-table ${this.contained ? 'table-contained' : ''}`, style: { direction: this.direction ? 'rtl' : 'ltr' } }, h("slot", { key: 'd43e32ddf5f1060bf26d933b14dd53ccc044b8f0' }))));
    }
