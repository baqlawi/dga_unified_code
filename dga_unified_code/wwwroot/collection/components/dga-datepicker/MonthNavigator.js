...
export class MonthNavigator {
    ...
    render() {
        return (h("div", { key: 'd013e3fe41e41d6f6da82bdb460c6c607abdaa2d', class: "date-picker__navigator" }, h("div", { key: '5698eeb674f489c8a36ef6f6df4a59d943de65ae', class: "date-picker__navigator-label" }, this.currentMonth.toLocaleDateString(this.RTL ? 'ar' : 'default', {
            month: 'long',
            // year: 'numeric',
        }), " ", h("span", { key: '4ec3cf77600f773a880bc7412f31296b3cc30ba0', class: "year-selector", onClick: this.toggleYearsDropdown, style: {
                cursor: 'pointer',
                position: 'relative',
                display: 'inline-flex',
                alignItems: 'center'
        ...
        // {true && (
        h("ul", { key: '4a919ae107fa5b770c152e3aa12e765f1a26eb1f', class: "dga-breadcrumb-dropdown", ref: (el) => this.yearDropdownRef = el }, this.yearsList.map(year => (h("li", { key: year, class: `dga-breadcrumb-dropdown-item ${year === this.currentMonth.getFullYear() ? 'selected-year' : ''}` }, h("a", { onClick: (e) => this.handleYearSelect(year, e) }, h("span", { class: "link__label" }, year))))))))), this.showArrows && (h("div", { key: '0cb18c3aa2c5c6f1b7415343eec9897c26fcf7a1', class: "date-picker__navigator-buttons" }, h("dga-button-v2", { key: 'f1699ce886002859434435b7ec0f4b9c0ead66fc', variant: "subtle", size: "lg", iconOnly: true, leadIcon: true, leadIconProps: {
                name: 'arrow-left-02',
                variant: 'stroke',
                type: 'rounded',
            }, onClick: this.handlePrevClick }), h("dga-button-v2", { key: '973ce7cbb9ebf940049f21bf336915b689b907f2', variant: "subtle", size: "lg", iconOnly: true, leadIcon: true, leadIconProps: {
                name: 'arrow-right-02',
                variant: 'stroke',
                type: 'rounded',
