...
export class DgaDropdown {
    ...
    render() {
        ...
        return (h(Host, { key: 'ae50cbbfce641b6b61b72c28109ee8ba856ba1d7', id: this.componentId, style: this.rootStyles, dir: document.documentElement.getAttribute('dir') }, h("div", { key: '2290ca244dfe12af4ddb2ce3ad6889cf8eb197e8', id: this.id, ref: el => (this.containerRef = el), class: Object.keys(dropdownClasses)
                .filter(key => dropdownClasses[key])
                .join(' ') }, h("button", { key: '6c1dff527003975440c4c01741a87a972d49b844', class: "dropdown__btn", ref: el => (this.btnRef = el), disabled: this.disabled || this.readonly, onClick: this.handleToggleDropdown.bind(this), onMouseDown: this.handleAddPressed.bind(this), onMouseUp: this.handleRemovePressed.bind(this), onMouseOut: this.handleRemovePressed.bind(this), type: "button" }, h("span", { key: '4fbd3d638498bc3b7e1f112b6c8daaa9e9050e8c', class: "dropdown__label" }), h("span", { key: '7b1f04fea3588baad69ca3b7a8ce6992962c7d84', class: "dropdown__label-placeholder" }, this.placeholder), h("span", { key: 'be8d900db2c5990bf44a14bec9ef4247f3cc8185', class: "dropdown__chevron" }, h("dga-icon", { key: '94da66595efab3446200dea44c06e4c3e5f70361', icon: 'ArrowDown01Icon', variant: "stroke" }))), h("ul", { key: 'ba99405f0c9d054b85fe4625936f7b20c9449398', class: "dropdown__list" }, this.optionList.map((option, index) => (h("li", { key: option[this.trackBy] || guid() }, h("button", { class: {
