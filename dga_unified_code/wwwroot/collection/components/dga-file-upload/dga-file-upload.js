...
export class DgaFileUpload {
    ...
    render() {
        return (h("div", { key: 'b2229fc831b450f904f49dd55f5f39f2932d5e84', class: `file-upload ${this.dragState ? 'file-upload--drag-over' : ''} ${this.disabled ? 'file-upload--disabled' : ''}` }, h("input", { key: 'f57475229b87fb5a3cb1802127adcd5d40b814a1', type: "file", id: this.id, name: this.name, class: "file-upload__input", accept: this.accept, multiple: this.multiple, "aria-hidden": "true", onChange: this.handleFileSelection, ref: el => (this.fileInputRef = el) }), h("label", { key: '10f63ca5ecd1ab621bd0f9a1a9a4e15e50ad3dd8', htmlFor: this.id, class: "file-upload__drop-area" }, h("span", { key: '61954866e158f4ada389670469286e770ad0012b', class: "file-upload__icon" }, h("i", { key: 'aaef312a708380c23c0a682f61958dfdc90e6491', class: "hgi-stroke hgi-file-upload", style: { fontSize: "20px" } })), h("div", { key: '9541460c33edf715a6010e8e8f06b3cbe8e88850', class: "file-upload__content" }, h("p", { key: '92b7924152430378cecccafe66fcd50656119340', class: "file-upload__instructions" }, this.title), h("p", { key: '6cc00b39771f3e492243462c67dcd69927a2ed18', class: "file-upload__formats" }, this.fileTypesText)), h("button", { key: 'a6f93ae28db20fda5fb47a3f7ed843060d78e02f', class: "btn btn--md btn--secondary", "aria-label": "Browse Files", disabled: this.dragState || this.disabled, type: "button", onClick: () => { var _a; return (_a = this.fileInputRef) === null || _a === void 0 ? void 0 : _a.click(); } }, h("span", { key: 'fab7028476b4273d85eaa73e7866045927b24e45' }, this.actionName))), h("div", { key: 'e1b83104261c9d7098767e68308f1fee9d675a16', class: "file-upload__files-list" }, this.files.map((file, index) => this.renderFile(file, index)))));
    }
