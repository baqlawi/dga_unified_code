...
export class DgaActionMenu {
    ...
    render() {
        return (h(Host, { key: 'a8ad2add15ace376352700bc89dbb2a37bccde6a', dir: document.documentElement.getAttribute('dir') }, h("div", { key: 'bf58c5ea2843f02ee7af30c0d6edcb6e3e0b1766', style: { position: 'relative' } }, h("slot", { key: 'b8392624627b1dc7a731aa432826eceb46c99fd0', name: "trigger" }), this.open && (h("div", { key: 'dddf24c9f242b2b8d16b29cde43b90a19ded2462', class: "dga-breadcrumb-dropdown", style: this.getPlacementStyle() }, h("slot", { key: 'cc38292ae8a59bc6f4624a8535e8b7c93e6f3a35', name: "menu" }))))));
    }
