...
export class DgaStructuredList {
    ...
    render() {
        return (h("div", { key: '33ef433c324bab123606987e791dd16e9ade03ea', class: `table-wrapper ${this.contained ? 'table-contained' : ''}` }, h("table", { key: '857105ae0427b8fe7aa1dbdb361c6c903769dd6e', class: `azm-structured-table ${this.contained ? 'table-contained' : ''}`, style: { direction: this.direction ? 'rtl' : 'ltr' } }, h("thead", { key: '68aaf59f6e5c36366fe6089f0e0ada9cc7e0bd18' }, h("tr", { key: '1539239328912eb343f78cc6d43ce4adbb6ec400', class: `${this.rowDivider ? 'row-divider' : ''}` }, this.cells.map(({ title }, index) => (h("th", { key: index }, title))))), h("tbody", { key: '975aa2cbb9cebd5e7b0f09d79037e96f04f0e48c' }, this.sortedData.map((row, rowIndex) => (h("tr", { class: `${this.rowDivider ? 'row-divider' : ''} ${this.alternate ? 'alternate' : ''}`, key: rowIndex }, this.cells.map(({ El, customAttribute, propertyName, type, colSpan }, cellIndex) => (h("td", Object.assign({ key: cellIndex, colSpan: colSpan || 1 }, ((customAttribute === null || customAttribute === void 0 ? void 0 : customAttribute.key) && {
