...
export class DgaTableOfContent {
    ...
    render() {
        return (h(Host, { key: '858fda35574248e169c09b933de6796d42543f7a', id: this.sxHandler.getId(), style: this.sxHandler.getStyles() }, h("aside", { key: '2510628f8c03d86d6cd887ea5e964374534a6288', class: `table-of-content ${this.rtl ? 'rtl' : ''}`, dir: this.rtl ? 'rtl' : 'ltr' }, h("div", { key: 'e233dd4dd1468f3dcc80fd6045db7881e64320fa', class: "table-of-content__header" }, h("p", { key: '5b12d22dff7ca399db6973438fddc0ac0284b64c', class: "text-sm-regular" }, this.subTitle), h("h4", { key: '4daf5b39d0d2699dee332ea976370c4373197906', class: "text-xl-semibold" }, this.tocTitle)), h("div", { key: 'c865b057bb4661b304bc904f6b863b54c214a858', class: "table-of-content__body" }, h("ul", { key: 'd3ac59be139ba7bf92102da96c06a9963c812c19', class: "table-of-content__tab-list" }, this.sections.map(tab => tab.Children ? (h("div", null, this.renderTab(tab), tab.Children.map(subTab => this.renderSubTabs(subTab)))) : (this.renderTab(tab))))))));
    }
            ...
            "sections": {
                ...
                "complexType": {
                    ...
                    "references": {
                        "TabType": {
                            "location": "local",
                            "path": "/home/mahmoud/Documents/platform-code-cross-platform-storybook/packages/core/src/components/dga-table-of-content/dga-table-of-content.tsx",
