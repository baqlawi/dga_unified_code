...
export class DgaTabs {
    ...
    render() {
        var _a;
        return (h(Host, { key: '17d2475e6da8393562a4af7263afac102b5ccbd9', id: this.componentId, style: this.rootStyles }, h("ul", { key: '41b67c39a33888ebed49adef7d141547c34b3a86', class: `dga-tabs-list dga-tabs-list--${this.orientation} ${this.divider ? 'dga-tabs-list--divider' : ''} ${this.flush ? 'flush' : ''} ${this.extraClass}` }, (_a = this.tabsList) === null || _a === void 0 ? void 0 :
            _a.slice(0, 5).map((tab, index) => (h("li", { key: index }, this.external ? (h("a", { href: tab.link, class: `dga-tabs-list__item dga-tabs-list__item--${this.size} ${this.activeTab === index ? 'dga-tabs-list__item--active' : ''} ${this.disabled ? 'disabled' : ''}`, onClick: e => {
                ...
                } }, (tab === null || tab === void 0 ? void 0 : tab.tabIcon) && h("div", { class: "dga-tabs-list__icon" }, this.renderIcon(tab === null || tab === void 0 ? void 0 : tab.tabIcon, tab === null || tab === void 0 ? void 0 : tab.iconProps)), h("div", { class: "dga-tabs-list__label" }, tab === null || tab === void 0 ? void 0 : tab.label)))))), this.orientation === 'horizontal' && this.tabsList.length > 5 && (h("li", { key: '28eb7e9ce2be2a88ee8aeb0f089cf88f6af0e37e', class: "breadcrumb-item ellipsis" }, h("dga-button", { key: 'd6b906f179e2c64083d9fdb62f45885980bb49c6', iconOnly: true, leadIcon: true, leadIconProps: {
                name: 'MoreHorizontalCircle01Icon',
                size: 17,
                variant: 'solid',
            }, label: "Button", onClick: () => {
                this.toggleMenu();
            }, size: "md", variant: "subtle", disabled: this.disabled, "aria-haspopup": "true", "aria-expanded": this.isMenuOpen ? 'true' : 'false' }), this.isMenuOpen && (h("div", { key: 'a5e5cf6644305dde6e94abfe6e025419e7b45bf7', class: "breadcrumb-dropdown" }, h("dga-tabs", { key: 'a229b851f769a043a5dd199b9fa3b6463f7e205b', size: "md", orientation: "vertical",
            // tabIcons: true,
            ...
            "tabsList": {
                ...
                "complexType": {
                    ...
                    "references": {
                        "ITab": {
                            "location": "local",
                            "path": "/home/mahmoud/Documents/platform-code-cross-platform-storybook/packages/core/src/components/dga-tabs/dga-tabs.tsx",
