...
export class NdsTableOfContent {
    ...
    render() {
        return (h(Host, { key: 'ac0ce1543b8a4556b22cfdb1f7e8761745c31c10', id: this.sxHandler.getId(), style: this.sxHandler.getStyles() }, h("aside", { key: '854fbaa37dc984d9368bc6501035d36046c15c0e', class: `table-of-content ${this.rtl ? 'rtl' : ''}`, dir: this.rtl ? 'rtl' : 'ltr' }, h("div", { key: '205782a0e4cadd5e711134f50b41178083fc740c', class: "table-of-content__header" }, h("p", { key: '9d75819bd96b5194f84cf24df34140c2be7d82dc', class: "text-sm-regular" }, this.subTitle), h("h4", { key: '47869006813d4fa830e53e1bc1b2a3c3d35790a8', class: "text-xl-semibold" }, this.tocTitle)), h("div", { key: '125041a9d96ef160f5389fa9e72a5400eec6499f', class: "table-of-content__body" }, h("ul", { key: 'c8d7cec0a4d30ea91dfd867b132fb633d775f01d', class: "table-of-content__tab-list" }, this.sections.map(tab => tab.Children ? (h("div", null, this.renderTab(tab), tab.Children.map(subTab => this.renderSubTabs(subTab)))) : (this.renderTab(tab))))))));
    }
            ...
            "sections": {
                ...
                "complexType": {
                    ...
                    "references": {
                        "TabType": {
                            "location": "local",
                            "path": "/home/mahmoud/Documents/platform-code-cross-platform-storybook/packages/core/src/nds-components/nds-table-of-content/nds-table-of-content.tsx",
